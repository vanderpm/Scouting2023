...
import com.frc107.scouting2024.BuildConfig;
...
import com.frc107.scouting2024.viewmodel.PitViewModel;
...
public class PitActivity extends BaseActivity {
    private RadioWrapper autonOpWrapper;
    private RadioWrapper autonPrefWrapper;
...
//        autonOpWrapper = new RadioWrapper(findViewById(R.id.autonOperationsRadioQuestion), viewModel);
//        autonPrefWrapper = new RadioWrapper(findViewById(R.id.autonPreferenceRadioQuestion), viewModel);
//        highestRocketLevelWrapper = new RadioWrapper(findViewById(R.id.highestRocketLevelautonRadioQuestion), viewModel);
    ...
    protected void onDestroy() {
        ...
        autonOpWrapper.cleanUp();
        autonPrefWrapper.cleanUp();
